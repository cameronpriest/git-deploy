...
begin
  ...
  if changed_files.include?('Gemfile') || changed_files.include?('Gemfile.lock')
    ...
    raise "Bundle installation failed!" unless `umask 002 && rvm 1.8.7@base exec bundle check` == "The Gemfile's dependencies are satisfied"
  end
